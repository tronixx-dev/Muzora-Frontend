    ...
    >
      ...
      <aside className="hidden md:flex w-64 flex-col flex-shrink-0 gap-2 p-2">
            ...
            {libraryItems.map(({ href, label, icon: Icon }) => (
              ...
              >
                <div className={`w-10 h-10 rounded flex items-center justify-center flex-shrink-0 ${
                  ...
                  <Icon
                    size={16}
                    className={router.pathname === href ? 'text-black' : 'text-gray-400'}
                  />
                </div>
                <div>
                  <p
        ...
        {user && (
          <Link
            href="/profile"
            className="rounded-lg px-4 py-3 flex items-center gap-3 hover:bg-white/5 transition-colors"
            style={{ backgroundColor: 'var(--bg-secondary)' }}
          >
      ...
      {/* Main content */}
      <main
        className="flex-1 overflow-y-auto md:rounded-lg md:m-2 md:ml-0 pb-36 md:pb-28"
